---
title: Install
description: Install jvim on Linux (x64 / arm64). npm or standalone binary.
---
...
```bash
VERSION="<VERSION>"  # pick the desired release; see Releases page for the latest
...
- Read the [FAQ](/jvim-public/en/faq/) for common workflow questions.
