...
description: Versioning, release cadence, support window, verification checklist, and license terms.
---
...
- Every breaking change lands in [`CHANGELOG.md`](https://github.com/jhl-labs/jvim-public/blob/main/CHANGELOG.md) under a
...
[transparency reports](/jvim-public/en/transparency/reports/).
...
[security issue](/jvim-public/en/security/). It would indicate a regression in our
release pipeline.
...
[LICENSE](https://github.com/jhl-labs/jvim-public/blob/main/LICENSE)) in this repository and also ships as `LICENSE`
...
- Security issue in a release → [security policy](/jvim-public/en/security/)
